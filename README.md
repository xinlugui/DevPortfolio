...
![preview](https://raw.githubusercontent.com/xinlugui/xinlugui.dev/main/thumbnail.png)
...
```bash
$ git clone https://github.com/xinlugui/xinlugui.dev.git
$ cd xinlugui.dev
$ npm install
$ npm run dev
```
...
Licensed under the [MIT license](https://github.com/xinlugui/xinlugui.dev/blob/main/LICENSE).
